        ...
        <motion.div variants={fadeInUp}>
          <Accordion type="single" collapsible className="w-full max-w-2xl mx-auto">
            {[
              ...
              { question: "How long does it take to see results?", answer: "SEO is a long-term strategy. While some improvements can be seen within a few weeks, significant results typically take 3-6 months." },
